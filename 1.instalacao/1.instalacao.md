...
### Criando um user no pgadmin4
```bash
# Criando nosso usuário pgadmin4
sudo /usr/pgadmin4/bin/setup-web.sh
```

É com esse user and password que vamos acessar o pgadmin4, tanto na web quanto no desktop.  


### Alterando o user e a senha no pgadmin4
Para alterar o email e/ou senha, basta remover o arquivo `pgadmin4.db`:

```bash
sudo rm /var/lib/pgadmin/pgadmin4.db; # removemos o arquivo
sudo /usr/pgadmin4/bin/setup-web.sh; # usamos o command pra cadastrar um novo usuario novamente
```
