<h1 align="center"; style="color:">PRIMARY KEY (chave primária) <img src="https://cdn-icons-png.flaticon.com/512/807/807241.png" width="42px" align="right"></h1> 
...
Como colocamos a constraint direto no campo, o nome dessa constraint será um nome padrão que o psql vai dar.
...
## Definindo uma PRIMARY KEY na criacação da table, e especificando o nome dessa constraint.
