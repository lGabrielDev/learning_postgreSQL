...
1. Acessando a table **address**, faça uma query filtrando apenas os dados do **distrito** **california**.
    ...
    ⚠️ Não é possível usar alias na cláusula WHERE, porque o WHERE é processado antes do SELECT. Isso significa que o alias ainda não existe quando o WHERE está sendo avaliado.
