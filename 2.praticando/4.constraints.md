...
* `PRIMARY KEY` -> Identifica um dado me uma table.
...
> É uma boa prática toda tabela ter uma colum de `PRIMARY KEY`.

> Outra boa prática é bom utilizar o datatype de auto_increment (`SERIAL`).
...
<br>
Criar um resumo exclusivo para primary key and foreign key
